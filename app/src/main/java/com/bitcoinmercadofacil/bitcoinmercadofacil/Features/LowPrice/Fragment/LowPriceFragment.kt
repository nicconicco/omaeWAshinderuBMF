package com.bitcoinmercadofacil.bitcoinmercadofacil.Features.LowPrice.Fragment
...
class LowPriceFragment : BaseFragment() , JsoupHtmlContract.View, JsoupAdapter.onClickDetail{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, icicle: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_low_price, container, false)
    }
