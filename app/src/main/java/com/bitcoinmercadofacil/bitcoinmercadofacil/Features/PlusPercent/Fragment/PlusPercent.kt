package com.bitcoinmercadofacil.bitcoinmercadofacil.Features.PlusPercent.Fragment
...
class PlusPercent : BaseFragment() , JsoupHtmlContract.View, JsoupAdapter.onClickDetail{
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, icicle: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_plus_percent, container, false)
    }
