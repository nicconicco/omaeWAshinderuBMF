package com.bitcoinmercadofacil.bitcoinmercadofacil.Features.PlusPrice.Fragment
...
class PlusPriceFragment : BaseFragment() , JsoupHtmlContract.View, JsoupAdapter.onClickDetail{
